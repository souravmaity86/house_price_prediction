...
from sklearn.linear_model import LinearRegression  # change based on model

from src.exception import CustomException
from src.logger import logging, project_dir
from src.utils import save_object, evaluate_model_linear_regression
...
class ModelTrainer:
    ...
    def initiate_model_training(self, train_arrc, test_arrc):
        try:
            ...
            model_report= evaluate_model_linear_regression(
